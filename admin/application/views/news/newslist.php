    ...
    <?php } ?>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of News
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <a href="<?php echo base_url();?>news/newsadd" class="btn btn-black" style="float:right">Add News</a>
                </h4>
            </div>
                    ...
                    <table id="example" class="table">
                        ...
                        ?>
                            <tr>
                                    ...
                                    <td>
                                        <?php echo anchor('news/editnews/'.$row->NewsId,'<i class="ficon icon-pencil2"></i>'); ?>
                                        <a onclick="deletedata('<?php echo $row->NewsId; ?>')" ><i class="ficon icon-bin"></i></a>
                                    </td>  
                                </tr>      
                                <?php
                                $i++;
...
function deletedata(NewsId){  
  ...
  // alert(id);
        $('#yes_btn').click(function(){
                ...
                url="<?php echo base_url();?>news/news_delete/";
                //alert(url);
                $.ajax({
                url: url,
                type: "post",
